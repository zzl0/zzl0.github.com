...
注: 本篇是 [DPark 漫谈系列](/2014/08/05/dpark.html)的第二篇.

## RDD from scratch

RDD（Resilient Distributed Dataset）是 DPark 的核心概念。
它是一个分布式的惰性的数据集，[上篇](/2014/10/13/dpark-basic.html)
...
[上篇](/2014/10/13/dpark-basic.html)结束时，我们给出了一个词频统计的示例，
...
faltMap 的效果可以参考[上篇](/2014/10/13/dpark-basic.html)中的习题2，
